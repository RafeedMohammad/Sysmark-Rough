...
{{--<form action="{{url('/saveproduct')}}" method="POST" class="form-horizontal">--}}
    ...
    <div class="form-group">
        ...
        {{Form::text('product_name', $product->product_name, ['placeholder' => 'Product Name', 'class' => 
        'form-control'])}}
    ...
    <div class="form-group">
        ...
        {{Form::number('product_price', $product->product_price, ['placeholder' => 'Product Price', 'class' => 
        'form-control'])}}
    ...
    <div class="form-group">
        ...
        {{Form::text('product_category', $product->product_category, ['placeholder' => 'Product Category', 'class' => 
        'form-control'])}}
    ...
    <div class="form-group">
        ...
        {{Form::textarea('product_description', $product->product_description, ['placeholder' => 'Product Description', 'class' => 
        'form-control'])}}
